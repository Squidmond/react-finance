  ...
  render() {
    return (
      <div className="jumbotron">
        ...
        <p className="lead">
          React Finance uses React, Redux, and IEX Trading's Web API to show you
          how to develop a React application
        </p>
        <hr className="my-4" />
        ...
        <h6>
          ...
          ishing for its acquisitiendum. Because he will ab hold, unless but
